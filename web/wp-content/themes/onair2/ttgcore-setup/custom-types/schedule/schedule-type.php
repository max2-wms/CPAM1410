...
$fields = array(
    ...
    array(
		...
		'type'  => 'checkbox_group',
		'options' => array( 
           array('label'=> esc_attr__("Monday","onair2"), 'value' => 'mon'),
           array('label'=> esc_attr__("Tuesday","onair2"), 'value' => 'tue'),
           array('label'=> esc_attr__("Wednesday","onair2"), 'value' => 'wed'),
           array('label'=> esc_attr__("Thursday","onair2"), 'value' => 'thu'),
           array('label'=> esc_attr__("Friday","onair2"), 'value' => 'fri'),
           array('label'=> esc_attr__("Saturday","onair2"), 'value' => 'sat'),
           array('label'=> esc_attr__("Sunday","onair2"), 'value' => 'sun')
           )
		),
