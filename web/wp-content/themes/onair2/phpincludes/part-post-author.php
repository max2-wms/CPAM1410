...
<div class="qt-post-author qt-card">
	<div class="row">
		...
		<div class="qt-post-author-link col s12 m3 l3 aligncenter">
			<a href="<?php echo esc_attr( get_author_posts_url( get_the_author_meta('ID') ) ); ?>" class="qt-btn qt-btn-large qt-btn-primary"><?php echo esc_attr__("Author's archive","onair2"); ?></a>
		</div>
	</div>
</div>
<!-- AUTHOR PART END ========================= -->
