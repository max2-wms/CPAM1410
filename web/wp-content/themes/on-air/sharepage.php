...
?>
	...
	data-url="<?php echo esc_js(esc_url($permalink)); ?>"  
	data-description="<?php 	echo esc_js(esc_attr($data_description)); ?>"  
	class="prettySocial qw-left qw-sharelink tooltipped" data-position="top" data-media="<?php 	echo esc_js(esc_attr($data_media)); ?>" data-tooltip="Share on Pinterest"><span class="qticon-pinterest"></span></a>
