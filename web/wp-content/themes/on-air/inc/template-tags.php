			...
			<div class="row">
				...
				<div class="col s10">
					<p class="qw-commentheader qw-small qw-caps">
						<?php esc_attr_e( 'Pingback:', '_s' ); ?> <?php edit_comment_link( '<i class="glyphicon  glyphicon-pencil"></i>', '<span class="edit-link">', '</span>' ); ?>
					</p>
			...
			<div class="row">
				...
				<div class="col s10">
					...
					<div class="comment-content">
						<p class="qw-commentheader qw-small qw-caps">
							<?php printf( esc_attr__( '%s &nbsp; On &nbsp;', '_s' ), sprintf( '<cite>%s</cite>', get_comment_author_link() ) ); ?>
						...
						<p class="comment-awaiting-moderation"><?php echo esc_attr__( 'Your comment is awaiting moderation.', '_s' ); ?></p>
						<?php endif; ?>
						<div class="comment-text">
							<?php comment_text(); ?>							
						</div>
